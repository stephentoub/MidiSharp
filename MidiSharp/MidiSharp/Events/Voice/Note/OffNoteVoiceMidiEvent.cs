//----------------------------------------------------------------------- 
// <copyright file="OffNoteVoiceMidiEvent.cs" company="Stephen Toub"> 
...
namespace MidiSharp.Events.Voice.Note
{
    ...
    public sealed class OffNoteVoiceMidiEvent : NoteVoiceMidiEvent
    {
        /// <summary>The category status byte for NoteOff messages.</summary>
        internal const byte CategoryId = 0x8;
